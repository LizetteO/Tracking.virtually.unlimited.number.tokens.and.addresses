...
title: Print engine controller for image processing page data
...
url: http://patft.uspto.gov/netacgi/nph-Parser?Sect1=PTO2&Sect2=HITOFF&p=1&u=%2Fnetahtml%2FPTO%2Fsearch-adv.htm&r=1&f=G&l=50&d=PALL&S1=07933046&OS=07933046&RS=07933046
...
---
This is a Continuation of Ser. No. 11 766 043 filed Jun. 20 2007 which is a Continuation of Ser. No. 11 003 481 filed on Dec. 6 2004 now issued U.S. Pat. No. 7 298 519 which is a Continuation of Ser. No. 10 636 247 filed on Aug. 8 2003 which is a Divisional of Ser. No. 09 436 747 now issued as U.S. Pat. No. 6 687 022 all of which are herein incorporated by reference
...
In one broad form the invention comprises a method of determining the amount of ink in a printer reservoir after a page is printed comprising the steps of 

multiplying the said number of dots by the volume of each dot to determine the volume of ink used in the printing of the page and

subtracting the calculated volume of ink used in printing of the page from the volume of ink in the reservoir prior to printing of that page to obtain the volume of ink in the reservoir after printing that page.

In a further form the invention comprises an apparatus for determining the volume of ink in a cartridge after a page is printed by a printhead through nozzles discharging dots of ink from said cartridge to form the image comprising 
...
a sensor associated with said printhead to count the number of dots of ink discharged from said nozzles 

a processor unit for extracting data from the processor and memory unit to determine the volume of the an ink dot discharged from the nozzles and in communication with said sensor to receive data on the number of dots printed for the last page multiplying the dot volume by the number of dots to determine the amount of ink used in printing the page and inputting this data to the processor and memory unit to update the volume of ink remaining in the cartridge.
...
When a contone object of color Cand opacity is composited with the contone layer the contone layer and the black layer are updated as follows 1 if 0 Rule 3 x y 0 if x y 0 Rule 4 0 if 0 Rule 5 1 Rule 6 
