...
Process Asset Type asset type that represents either a generic process that is used to identify generic business services or an end to end process in operation.
