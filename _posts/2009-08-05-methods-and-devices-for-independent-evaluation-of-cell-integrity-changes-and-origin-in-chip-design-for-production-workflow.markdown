...
This example compares the digests from a small design OASIS file against the GDSII libraries used to build it. The design digest file is named design from versions.txt 
