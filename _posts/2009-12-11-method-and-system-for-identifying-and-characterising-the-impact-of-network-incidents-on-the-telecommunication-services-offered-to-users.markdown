...
the stabilization module is configured to make incident mutations modifying the extent or the type of the service incident to which they belong progress to the notification module and
