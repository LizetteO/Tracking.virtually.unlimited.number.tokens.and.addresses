...
A user can view any file on the system by using .. to traverse the filesystem upward. For example the following as shown in Table 14 would show all configuration information including account names.
